...
const translations = {
  zh: {
    ...
    login: "系統驗證",
    pwdPlace: "請輸入密碼 (admin)",
    enter: "登入",
    wrongPwd: "密碼錯誤，預設為 admin",
    regTitle: "賓客登記",
    regSub: "請上傳照片以便抽獎",
    name: "姓名 (Name)",
    phone: "電話 (Mobile)",
        ...
        <div className="relative bg-neutral-900/80 border border-white/20 p-10 rounded-3xl w-full max-w-sm backdrop-blur-xl shadow-2xl animate-in fade-in zoom-in duration-500 z-50">
            ...
            <form onSubmit={handleSubmit}>
                <input 
                    ...
                    className="w-full bg-white/10 border border-white/20 text-white p-4 rounded-xl mb-6 focus:ring-2 focus:ring-red-600 focus:border-transparent outline-none transition-all text-center tracking-[0.3em] placeholder:tracking-normal placeholder:text-white/30"
                />
...
// ... (GuestView, AdminDashboard, ProjectorView, WheelComponent 保持不變，下方完整代碼已包含) ...
