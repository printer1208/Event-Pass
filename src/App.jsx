...
const translations = {
  zh: {
    title: "Tesla Annual Dinner", sub: "2025 防重抽版",
    ...
    success: "簽到成功", duplicate: "已入場", error: "無效代碼", regSuccess: "登記成功",
    ...
    noWinner: "尚未抽出", drawn: "本獎項已抽出", winnerIs: "得主",
    addGuest: "新增賓客", searchList: "搜尋名單...", wonPrize: "獲獎紀錄"
  },
  en: {
    title: "Tesla Annual Dinner", sub: "2025 Anti-Replay",
    ...
    yourCode: "Entry Pass", yourSeat: "Your Seat",
    showToStaff: "Show to Staff", next: "Finish",
    scan: "Scanner", draw: "Control", prizeList: "Prize Manager",
    ...
    noWinner: "None", drawn: "Prize Drawn", winnerIs: "Winner",
    addGuest: "Add Guest", searchList: "Search List...", wonPrize: "Prize"
  }
};
...
const ProjectorView = ({ t, attendees, drawHistory, onBack, currentPrize, prizes }) => {
    ...
    const handleDrawEnd = (w) => { setWinner(w); };
...
// --- Reception Dashboard (V59 Logic: List Columns & Manual Seat) ---
       ...
       <main className="flex-1 p-4 flex flex-col items-center w-full max-w-7xl mx-auto">
          ...
          {tab==='seating' && (
              <div className="w-full flex-1 flex flex-col gap-4">
                  ...
                  {/* 🔥 V59: Manual Seat Input Restored */}
